                ...
                <div className=" max-w-screen-2x-1 container mx-auto md:px-20 px-4">
                    <div className="navbar bg-base-100">
                        <div className="navbar-start px-10">
                            ...
                            <a href="/Loginhome" className="btn btn-xs sm:btn-sm md:btn-md lg:btn-lg btn-link"><img src="https://www.lastik.com.tr/medias/lastik-logo.svg?context=bWFzdGVyfGltYWdlc3wzOTk5OHxpbWFnZS9zdmcreG1sfGFHSTJMMmcxWVM4NE9EUXdOREExTmpRM016a3dMMnhoYzNScGF5MXNiMmR2TG5OMlp3fGY2ZjRjOGUzMjI2OTg4MDU1ODhhNTFiZjhlNGRlY2VjMzAyYTg4MzcyZDQzMDEyMDczZTY4NjRiN2VmZmNkMmE" alt="" className='h-26 w-26 lg:h-26 lg:w-32' /></a>
                                    ...
                                    <a href="/Profile" className='text-customOrange'>
                                        <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar">
                                            <div className="w-10 rounded-full">
                                                <img alt="profil" src="https://png.pngtree.com/png-clipart/20230927/original/pngtree-man-avatar-image-for-profile-png-image_13001877.png" />
                                            </div>
                                        </div></a>
